...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'border-border bg-input text-ink flex h-12 w-full items-center justify-between gap-2 rounded-xl border px-4 text-sm transition outline-none',
      'placeholder:text-muted focus:border-brand focus:ring-brand/20 focus:ring-2',
...
>(({ className, children, position = 'popper', ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        'border-border bg-surface text-ink relative z-50 max-h-72 min-w-[8rem] overflow-hidden rounded-xl border shadow-lg',
